...
public class InterfaceLayout extends JFrame {
	...
	private JPanel innerContentPanePanel;
	...
	private void innerContentPanePanel() {
		// TODO Auto-generated method stub
		
		innerContentPanePanel = new JPanel(new BoxLayout(innerContentPanePanel, BoxLayout.X_AXIS));
		innerContentPanePanel.setBounds(20, 25, 1010, 400);
		
		setPanels();
		
		contentPane.add(innerContentPanePanel);
	}
	
	private void initCentralPanel() {
		// TODO Auto-generated method stub
		centralPanel = new JPanel(new BoxLayout(centralPanel, BoxLayout.Y_AXIS));
		...
		innerContentPanePanel.add(centralPanel);
	}
	...
	private void initPanelBattleCamp() {
		...
		innerContentPanePanel.add(panelBattleCamp);
	}
	...
	private void initPanelPlayer() {
		...
		innerContentPanePanel.add(panelPlayerMap);
	}
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfaceLayout frame = new InterfaceLayout();
