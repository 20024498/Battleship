...
public abstract class Player implements Serializable{
	 ...
	 * per la nave sia lecita, imposta le celle che il tipo di nave occuper� sulla 
	 ...
	 * @param x
	 * @param y
	 * @return un valore booleano che dice se la nave � stata poszionata o meno
	 */
	...
	/**
	 * Questa funzione controlla se una propria nave � stata colpita
	 * da una mossa del computer
	 * 
	 * @param x
	 * @param y
	 * @return ShipState.ILLESA la nostra nave non � statta colpita
	 * @return s.getState() ritorniamo lo stato della nave se non � stata affondata
	 */
	 ...
	 * solo dopo essersi assicurata che non lo sia gi�
	 * 
	 * @param x
	 * @param y
	 */
